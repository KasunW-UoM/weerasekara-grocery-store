    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span>/</span>
          <span className="text-app-green font-medium trancate max-w-[200px]">{product.name}</span>
        </nav>
        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
              <img src={product.image} alt={product.name} className="max-h-[360px] 
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              {/* Description */}
              <p className="text-xs text-app-text-light leading-relaxed mb-6">
                {product.description}</p>

              {/* stock */}
              <div className="text-sm text-app-success font-medium">
                {product.stock > 0 ? (
                  <span> Now...In Stock ({product.stock} available)</span>
