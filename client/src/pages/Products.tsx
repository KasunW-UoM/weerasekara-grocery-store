            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-2xl font-semibold text-app-green">
                  ...
                  <p className="text-sm text-app-textlight mt-0.5">{products.length} products found</p>
                </h1>
              </div>
              <div className="flex flex-col lg:items-center gap-3">
                {/* Mobile filter toggle */}
                <button onClick={() => (setMobileFilterOpen(true))} className="lg:hidden flex items-center gap-2 px-3 py-2
                ...
                <div className="relative">
                  <select value={sort} onChange={(e) => updateFilter("sort", e.target.value)}
                    ...
                    bg-white rounded-xl border border-app-border focus:border-app-green 
                  ...
                  w-2.5 h-3.5 text-app-text-light pointer-events-none"/>
                </div>
              </div>
            </div>
            {/*Product Grid */}
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <button onClick={clearFilters}
                  ...
                  hover:bg-app-green-light transition-colors">Clear Filters</button>
            ...
            {totalPages > 1 && (
              <div className="flex-center gap-2 mt-16">
                {Array.from({length: totalPages}).map((_,i)=> (
                  ...
                  transition-colors ${page === i + 1 ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}`}>
                    {i+1}
