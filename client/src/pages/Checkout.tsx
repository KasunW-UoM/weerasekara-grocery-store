    ...
    return (
      <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/products')} className=" px-5 py-2.5 bg-app-green text-white
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {steps.map((s, i) => (
            <div key={s.key} className="flex items-center gap-2">
              <button onClick={() => setStep(s.key)}
                ...
                text font-medium transition-colors ${step === s.key ?
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
            <h1 className="text-sm font-semibold text-app-green mb-4">Order Summary</h1>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>
                  {deliveryFee === 0 ?<span className="text-app-success">Free
                  </span> : `${currency}${deliveryFee.toFixed(2)}`}
                </span>
              </div>
