            ...
            <div className="space-y-4">{orders.map((order)=> (
              ...
              hover:shadow transition-all">
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-app-text-light">{new Date(order.createdAt).toLocaleDateString("en-US", 
                ...
                text-sm">
                  ...
                  <span className="font-semiboldtext-app-green">
                    {currency}{order.total.toFixed(2)}</span>
                </div>
              </Link>
            ))}</div>
          )}
