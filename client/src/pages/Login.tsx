  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="relative text-center px-12">
        <h2 className="text-4xl font-semibold text-white mb-4">Welcome back to Weerasekara Super Market 
          <br/>- Grocery Delivery Store -</h2>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center mb-6">
                ...
                <span className="text-2xl font-semibold text-app-green">Weerasekara Super Market</span>
