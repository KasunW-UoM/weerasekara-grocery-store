...
const ProductCard = ({ product }: Props) => {
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow hover:shadow-md transition-all
    duration-300 group animate-fade-in cursor-pointer" 
        ...
        <div className="p-3.5 text-zinc-700">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-app-text-light black">/{product.unit}</span>
