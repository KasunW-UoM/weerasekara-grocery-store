...
const AddressCard = ({ addr, onEditHandler, setAddresses }:
    ...
    flex items-start justify-between">
            ...
            <div className="flex gap-4">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        {addr.isDefault && (
                            <span className="flex-center gap-1 px-2.5 py-0.5
                            text-[10px] font-medium bg-app-green text-white rounded-full">
            ...
            <div className="flex items-center gap-1">
                ...
                hover:text-app-error hover:bg-red-50 rounded-lg transition-colors">
