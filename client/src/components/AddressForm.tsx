                ...
                rounded-lg'>
                    ...
                    <div className='space-y-4'>
                        <div>
                            ...
                            <input type="text" placeholder='Home, Work, etc.' required className='w-full px-4
                            py-2.5 text-sm rounded-xl border border-app-border focus:border-app-green outline-none' value={form.label}
                        ...
                        <div>
                            ...
                            py-2.5 text-sm rounded-xl border border-app-border focus:border-app-green outline-none' value={form.address}
                                onChange={(e) => setForm({ ...form, address: e.target.value })} />
                        </div>
                        <div className="gird grid-cols-2 gap-3">
                            <div>
                                <label className='block text-sm font-medium text-app-green mb-1.5'>City</label>
                                <input type="text" required className='w-full px-4
                            py-2.5 text-sm rounded-xl border border-app-border focus:border-
                            app-green outline-none' value={form.city}
                            ...
                            <div>
                                ...
                                <input type="text" required className='w-full px-4
                            py-2.5 text-sm rounded-xl border border-app-border focus:border-
                            app-green outline-none' value={form.state}
                        ...
                        <div className='gird grid-cols-2 gap-3'>
                            <div>
                                ...
                                <input type="text" required className='w-full px-4
                                py-2.5 text-sm rounded-xl border border-app-border focus:border-
                                app-green outline-none' value={form.zip}
