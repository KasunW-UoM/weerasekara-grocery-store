      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
            ...
            text-xs font-semibold text-orange-300 bg-orange-300/10 rounded-full mb-5">
                <LeafIcon className="size-3"/> Farm-Fresh & Oraginc Products
            </span>
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white leading-tight mb-5">
                Nourish Your Home with
                <span className="text-orange-300 font-bold"> Earth's finest produce</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
                ...
                <Link to="/products" className="px-7 py-3 bg-white font-semibold rounded-full
