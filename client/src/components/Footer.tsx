        ...
        <footer className="bg-app-green text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        <Link to='/' className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-semibold">{footerData.brand.name} Weerasekara Store</span>
                        ...
                        <div className="flex gap-3">
                            {footerData.brand.socials.map((social, i) => (
                                <a key={i} href={social.link} className="size-9 rounded-lg bg-white/10 flex-center hover:bgwhite/2">
                ...
                justify-between items-center gap-4">
                    ...
                    {footerData.bottom.copyright} Develop By <span className="text-xs text-app-orange">Kasun Weerasekara</span></p>

                    <div className="flex gap-4">
                        {footerData.bottom.links.map((link, i)=>(
                            <a key={i} href={link.href} className="text-xs
