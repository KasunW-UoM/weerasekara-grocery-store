    ...
    z-50 shadow-2xl flex flex-col animate-slide-in-right">
                ...
                <div className="flex items-center justify-between p-5 border-b border-app-border">
                    <div className="flex items-center gap-2">
                        <ShoppingBagIcon className="flex items-center gap-2" />
                        ...
                        items.map((item) => (
                            <div key={item.product._id} className="flex gap-3 bg-app-cream/60 rounded-xl p-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h4 className="text-sm font-semibold trancate">
                                        {item.product.name}
                                    </h4>
                                    <p className="text-xs text-app-text-light">
                                        {currency} {item.product.price.toFixed} /
                                        {item.product.unit}
                ...
                {items.length > 0 && (
                    <div className="p-5 border-t border-app-border space-y-3">
                        ...
                        {deliveryFee > 0 && <p className="text-xs text-app-text-light text-center">
                            ...
                            text-base font-semibold border-t border-app-border pt-3">
                                <span>Total</span>
